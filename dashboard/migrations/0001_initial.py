    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('smtp_url', models.CharField(max_length=256)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fileField', models.FileField(default=None, null=True, upload_to='Media/dashboard/test_model')),
                ('timeField', models.TimeField(default=None, null=True)),
                ('manyToManyRel', models.ManyToManyField(to='dashboard.configuration')),
                ('oneToOneRel', models.OneToOneField(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='RequestLog',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, null=True, upload_to=dashboard.models.account_image_path)),
