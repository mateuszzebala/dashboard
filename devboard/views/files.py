...
from devboard.utils import get_type_of_file, create_zip_file, free_filename, free_folder_name
from devboard.views.auth import devboard_access
...
def zip_files(request):
    filename = 'temp.zip'
    destination_path = os.path.join(settings.TEMP_ROOT, 'devboard')
